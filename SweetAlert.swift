...
public class SweetAlert: UIViewController {
    ...
    public func showAlert(title: String, subTitle: String?, style: AlertStyle, buttonColor: UIColor) -> SweetAlert {
        self.showAlert(title, subTitle: subTitle, style: style, buttonTitle: "OK",buttonColor: buttonColor)
        return self
    }
    ...
    public func showAlert(title: String, subTitle: String?, style: AlertStyle,buttonTitle: String, action: ((isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
        self.showAlert(title, subTitle: subTitle, style: style, buttonTitle: buttonTitle,buttonColor: UIColor.color(89, green: 188, blue: 184, alpha: 1))
        userAction = action
        return self
    }
